...
- Sau khi AI chấm xong, giáo viên kiểm tra kết quả rồi bấm gửi kết quả AI.
- Khi gửi kết quả AI, submission được set `status = 'teacher_graded'`.
- Sinh viên chỉ nhìn thấy kết quả AI sau khi giáo viên đã gửi kết quả AI.
...
- Nếu sinh viên thuộc `variant`, sinh viên thấy kết quả AI sau khi giáo viên gửi kết quả AI.
